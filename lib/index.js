...
import { dayKeyOf, dshHome, loadUsageFile, migrateUsageDir, pruneBuckets, saveUsageFile } from "./storage.js";
...
export function apply(ctx) {
  ...
  runtime.usageFile = migrateUsageDir(dshHome()); // 旧目录 quota-monitor/ 自动搬到 dsh-token-quota/
  ...
  const triggerScan = () => {
    ...
    scanPromise = Promise.resolve(syncHarness()).finally(() => {
      scanPromise = null;
    });
    return scanPromise;
  };
