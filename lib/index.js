  ...
  ctx.on("session/event", (session, event) => {
    ...
    try {
      ...
      if (supplierId && usage && typeof usage === "object") {
        ...
        const sameStep =
          turn !== null && step !== null && !!last && last.dayKey === dayKey &&
          last.turn === turn && last.step === step;
        rec.tokens = sameStep ? rec.tokens - last.tokens + tokens : rec.tokens + tokens;
        if (turn !== null && step !== null) st.lastUsage = { dayKey, turn, step, tokens };
