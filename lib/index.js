...
import { dayKeyOf, dshHome, acquireUsageStore, usageFilePath } from "./storage.js";
...
export function apply(ctx) {
  ...
  if (usageStore.store.error) ctx.logger?.warn?.("[quota-monitor] %s", usageStore.store.error);
